...
export default function SafetyScreen() {
  ...
  const vettingSteps = [
    ...
    },
    {
      ...
      description:
        "Every sitter is thoroughly vetted by our team. We verify work rights, qualifications, certifications, and ensure all sitters meet Australian standards before they can join the platform.",
    },
    {
      step: "3",
