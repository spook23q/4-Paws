...
const env = {
  ...
  logoUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663302606279/DpSSOXlVEfkaJxnl.png",
...
const config: ExpoConfig = {
  ...
  newArchEnabled: true,
  description: "Cats Only. Purrfessional. - Expert cat sitting services with verified sitters, real-time messaging, and secure payments. Find trusted cat care near you.",
  ios: {
    supportsTablet: true,
